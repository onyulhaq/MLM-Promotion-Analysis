...
```{r}
#Enter Data
df <- read.csv("D:/Data Files/PSYC 575_Multilvl Model/MLM Promotion Analysis/employee_promotion.csv", header = T, na.strings = "")
...
```{r}
icc.m <- glmmTMB(is_promoted ~ 1 + (1|region) + (1|department),
                 data = df)
